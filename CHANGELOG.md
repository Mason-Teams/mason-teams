...
### Fixed
- fix: WriteClaudeSettings uses merge instead of overwrite
...
### Fixed
- fix: inject auth token in daemon reverse proxy

## [1.4.3] - 2026-04-13

### Changed
- chore: bump base image dependencies for security patches
